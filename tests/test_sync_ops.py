...
def test_reconcile_branch_merge_truth_functional_never_diverged_task_branch_classifies_as_redundant(tmp_path):
    """Functional test: task provenance splits zero unique commits to 'redundant'."""
