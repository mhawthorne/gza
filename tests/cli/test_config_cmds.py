...
class TestOnMaxCyclesConfigValidation:
    ...
    def test_config_on_max_cycles_default_merges_and_defers(self, tmp_path: Path) -> None:
        """Config.load ships merge-and-defer as the max-cycle default."""
        from gza.config import Config
...
class TestWatchConfigValidation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("review_verify_timeout_grace_seconds", ".nan", "'review_verify_timeout_grace_seconds' must be at least 1 second"),
            ("review_verify_timeout_grace_seconds", ".inf", "'review_verify_timeout_grace_seconds' must be at least 1 second"),
    ...
    def test_review_verify_timeout_and_deprecated_recommend_rebase_invalid_values_fail(
        ...
        assert loaded.review_verify_timeout_grace_seconds == 7.5
