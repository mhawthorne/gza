...
# Backward-compatible alias — prefer generate_slug in new code
generate_task_id = generate_slug
...
# Backward-compatible alias — prefer _extract_slug_suffix in new code
_slug_from_task_id = _extract_slug_suffix
